        ...
        <div className='mx-10 my-10'>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            <div>
              ...
              <input type="text" id="username" {...register('username')} placeholder="Username" className="text-custom-grey font-inter text-base leading-7 text-left mt-1 block w-full px-3 py-2 bg-white border-b-2 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
            </div>
            <div>
              <label htmlFor="email" className="block text-sm"></label>
              <input type="email" id="email" {...register('email')} placeholder="Email" className="text-custom-grey font-inter text-base leading-7 text-left mt-1 block w-full px-3 py-2 bg-white border-b-2 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
            </div>
            <div>
              <label htmlFor="password" className="block text-sm"></label>
              <input type="password" id="password" {...register('password')} placeholder="Password" className="text-custom-grey font-inter text-base leading-7 text-left mt-1 block w-full px-3 py-2 bg-white border-b-2 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
            </div>
            <div>
            ...
            <button type="submit" className="bg-custom-blue hover:bg-blue-700 text-white py-2 px-4 rounded-md font-medium font-inter text-normal leading-7 w-full">Sign Up</button>
          </form>
        </div>
      </div>
    </div>
