...
function SliderSection() {
  ...
  <p className="text-left font-poppins font-medium text-3xl leading-74 w-64  text-custom-black">Purely Distinct <span className='text-custom-blue'>/</span> Purely Superior<span className='text-custom-blue'>.</span></p>
  <p className="text-right font-popins font-semibold text-base leading-6 w-60 text-custom-black"><span className='text-custom-blue'>Purely Distinct</span> is a gift and decorations store based in <span className='text-custom-blue'>Struga, Macedonia.</span> Established in 2024.</p>
</div>
    </div>
  );
}
